...
export declare const SKIP_SUBAGENT_PENDING = true;
 ...
 */
export declare function resolvePetState(host: PetState, agent: string, pending: PendingSignal, demo: PetState | null): PetState;
