...
/** 浏览器侧宠物 API 基路径。 */
export const PET_API_PREFIX = '/api/anime25d-pet'
...
const ASSET_FILES = [
  { name: 'vendor/ag-psd.min.js', mime: 'text/javascript' },
  { name: 'lib/rigger.js', mime: 'text/javascript' },
  { name: 'lib/genericparts.js', mime: 'text/javascript' },
  { name: 'lib/eye_close.psd', mime: 'application/octet-stream' },
  { name: 'lib/mouth_close.psd', mime: 'application/octet-stream' },
  { name: 'models/sample.psd', mime: 'application/octet-stream' },
] as const
